...
$(document).ready(function(){
  $('.slider-logo').slick({
    ...
    slidesToShow: 4,
    slidesToScroll: 4,
    prevArrow: "<img src='img/base-img/icons/arrow.svg' class='prev' alt='1'>",
    nextArrow: "<img src='img/base-img/icons/arrow.svg' class='next' alt='2'>",
  responsive: [
    {
      breakpoint: 1424,
      settings: {
...
$(document).ready(function(){
  $('.case-slider').slick({
    dots: true,
    arrows: true,
    nextArrow: "<img src='img/base-img/icons/arrow.svg' class='case-arrow' alt='2'>",
    prevArrow: false
  });
});
